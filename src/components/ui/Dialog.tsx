...
const dialogInputClass = "w-full bg-black/20 border border-white/10 rounded-lg py-2.5 px-4 text-sm text-white placeholder:text-textMuted/40 focus:border-primary focus:ring-1 focus:ring-primary/30 outline-none transition-colors";

// Select style helper
const dialogSelectClass = "w-full bg-black/20 border border-white/10 rounded-lg py-2.5 px-4 text-sm text-white focus:border-primary focus:ring-1 focus:ring-primary/30 outline-none transition-colors appearance-none cursor-pointer";
