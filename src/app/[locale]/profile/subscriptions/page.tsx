            ...
            >
                ...
                <div className="flex items-center gap-2 bg-surface border border-white/5 rounded-lg p-1">
                    <button
                        ...
                        className={`flex items-center gap-2 px-3 py-1.5 rounded text-xs font-bold uppercase transition-colors ${sortType === 'update' ? 'bg-primary text-white' : 'text-textMuted hover:text-white'} `}
                    >
                        <RefreshCw size={12} />
                        {t('sortByUpdate')}
                    </button>
                    <button
                        ...
                        className={`flex items-center gap-2 px-3 py-1.5 rounded text-xs font-bold uppercase transition-colors ${sortType === 'subscribed' ? 'bg-primary text-white' : 'text-textMuted hover:text-white'} `}
                    >
                        <Calendar size={12} />
                        {t('sortBySubscribed')}
                    </button>
